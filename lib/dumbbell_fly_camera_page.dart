...
class DumbbellFlyCamPage extends StatefulWidget {
  ...
  const DumbbellFlyCamPage({Key? key, required this.title, required this.cameras}) : super(key: key);

  @override
  _DumbbellFlyCamPageState createState() => _DumbbellFlyCamPageState();
}
...
class _DumbbellFlyCamPageState extends State<DumbbellFlyCamPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final height = _cameraController != null
      ? width * _cameraController!.value.aspectRatio : width * (5 / 4);
